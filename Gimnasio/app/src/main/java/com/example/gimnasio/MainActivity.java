...
public class MainActivity extends AppCompatActivity {
    ...
    private void login(String nick, String password) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                // Aquí la respuesta es una cadena de texto (no un JSON)
                ...
                if (response.equals("Login exitoso")) {
                    ...
                    // Pasar el 'nick' como parámetro al Intent
                    intent.putExtra("usuarioNick", nick);
                    startActivity(intent);
                    finish();
                } else if (response.equals("Credenciales incorrectas")) {
                    // Acción cuando las credenciales son incorrectas
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                // Maneja el error de la solicitud (si existe)
